...
document.getElementById('showFormButton').addEventListener('click', function() {
    ...
    document.getElementById('googleForm').src = 'https://docs.google.com/forms/d/e/1FAIpQLSdKKPIsBeKxBfmBIQVPYTClKCQbSdDOQ6Kq9ChXoB3gv_dWYg/viewform?embedded=true';
});
